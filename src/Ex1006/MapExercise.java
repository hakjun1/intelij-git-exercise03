...
public class MapExercise {
    public static void main(String[] args) {
        //TreeMap(String,String) hash맵과 비교해서 빠른것으로 한다
       ...
       map.put ("유경준",	"https://github.com/KimDohyoun79/remote_Lion.git	");
        map.put("니엘	","https://github.com/kimkimj/create-repo1	");
      ...
      map.put ("강민환", 	"https://github.com/ReadnThink/Like_lion.git	");
      ...
      map.put ("단국영",	"https://github.com/Kim-Ji-Yeong/Java-exercise	");
      ...
      map.put ("노영인",	"https://github.com/joypeb/java-project-push-test	");
       ...
       map.put ("오세아",	"https://github.com/sjhlko/git-exercise-java");
      ...
      map.put ("한솔",	"https://github.com/hyunsik96/git-exercise-java-push	");
      ...
      map.put ("선유",    "	https://github.com/Changbum97/like-lion-java	");
       ...
       map.put ("양시은",	"https://github.com/SuInWoo/LikeLion2th	");
        map.put("노현" , "https://github.com/inkyu-yoon/IntelliJ_Commit_Test");
       ...
       map.put ("안주하",	"https://github.com/yjyj1023/java-Calculator2	");
        map.put("백은영" , "https://github.com/inkyu-yoon/IntelliJ_Commit_Test  ");
       map.put ("유민기",	"https://github.com/hyeonju01/likelion_repo3_test/tree/main/src/week3/day2	");
      map.put ("유민영" ,	"https://github.com/hakjun1/intelij-git-exercise03");
      ...
      map.put ("권재아",   "https://github.com/sandee-han/java-project-push-exercise	");
       ...
       map.put ("장우솔",	"https://github.com/cvivis/git_practice2022/tree/main	");
        ...
        //...90
        //list는 if문으로 하나하나 찾는다
        //숫자가 많을경우 list를 사용하면 속도가 안나올수 있다
        //map을 사용하면 이름을 사용하여 바로 찾을수 있다
        //
        System.out.println(map.get("임학준"));
    }
}
